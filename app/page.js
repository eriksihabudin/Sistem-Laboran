...
export default function App() {
  ...
  const [selectedBarangItems, setSelectedBarangItems] = useState([]); // Format: [{barangId, qty, nama}]
        ...
        <div className="p-6">
                ...
                {selectedBarang && (
                  <form onSubmit={handleEditBarang} className="space-y-4">
                    <div className="grid grid-cols-2 gap-4">
                      ...
                      <div className="space-y-2">
                        <Label htmlFor="edit-lokasiPenyimpanan">Lokasi Penyimpanan</Label>
                        <Select name="lokasiPenyimpanan" defaultValue={selectedBarang.lokasiPenyimpanan || " "}>
                          <SelectTrigger>
                            <SelectValue placeholder="Pilih lokasi penyimpanan" />
                          </SelectTrigger>
                          <SelectContent>
          ...
          <TabsContent value="laporan" className="space-y-4">
            <Tabs value={laporanType} onValueChange={setLaporanType}>
              ...
              {/* Laporan Lokasi Penyimpanan */}
              <TabsContent value="Lokasi Penyimpanan">
                <Card>
                  <CardHeader>
                    <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                      <div>
